...
class ProteinGAT(nn.Module):
    def __init__(self, num_features_prot, hidden_dim, output_dim, heads=2, dropout=0.3):
        ...
        self.pro_conv2 = GATConv(hidden_dim * heads, hidden_dim * heads, heads=heads, concat=True)
        self.pro_conv3 = GATConv(hidden_dim * heads * heads, hidden_dim * 2, heads=1, concat=False)
...
class DrugGCN(nn.Module):
    def __init__(self, num_features_mol, hidden_dim, output_dim, dropout=0.3):
        ...
        self.mol_conv3 = GCNConv(hidden_dim * 2, hidden_dim * 2)
...
# Binding Affinity Prediction 모델
